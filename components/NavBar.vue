<template>
  <div flex="~ row lg:col" justify-evenly items-center py5 lg:px5 border="t base lg:r" bg-black>
    <NuxtLink v-slot="{ isActive }" to="/" title="Home">
      <div text-2xl :class="isActive ? 'i-ph-house-fill text-primary' : 'i-ph-house'" />
    </NuxtLink>
    <NuxtLink v-slot="{ isActive }" to="/movie" title="Movies">
      <div text-2xl :class="isActive ? 'i-ph-film-strip-fill text-primary' : 'i-ph-film-strip'" />
    </NuxtLink>
